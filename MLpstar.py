...
np.random.seed(43)
velocitiesR = 10*(np.random.rand(40000, 1) - 0.5)
np.random.seed(44)
densitiesL = 2*(np.random.rand(40000, 1) + 0.125)
np.random.seed(45)
densitiesR = 2*(np.random.rand(40000, 1) + 0.125)
np.random.seed(46)
pressuresL = 2*(np.random.rand(40000, 1))
np.random.seed(47)
pressuresR = 2*(np.random.rand(40000, 1))

initial_vals = np.concatenate((velocitiesL, velocitiesR, densitiesL, densitiesR, pressuresL, pressuresR), axis=1)
exactvals = np.array([pstarexact(initial_vals[i])[0] for i in range(40000)])
exactshock = np.array([pstarexact(initial_vals[i])[1] for i in range(40000)])
